const listUrl = 'https://dauntless.fandom.com/wiki/Lanterns';

async function getUrls () {
  const urls = [];
  const lanternTables = document.querySelectorAll('table.wikitable.sortable');

  for (const table of lanternTables) {
